    ...
    public static class Ensure
    {
        ...
        public static void NotNullOrEmpty(string argument, string argumentName)
        {
            if (string.IsNullOrEmpty(argument))
                throw new ArgumentNullException(argument, $"{argument} should not be null or empty.");
        }
        ...
        {
            if (number < 0)
                throw new ArgumentOutOfRangeException(argumentName, $"{argumentName} should be nonnegative.");
        }
        ...
        {
            if (Guid.Empty == guid)
                throw new ArgumentOutOfRangeException(argumentName, $"{argumentName} should not be empty guid.");
        }
